...
public class App 
{
    public static void main( String[] args )
    {
        ...
        MountainBike mountainBike2 = new MountainBike(10,12,30);
        MountainBike mountainBike3 = new MountainBike(8,25,18);

        RoadBike roadBike = new RoadBike(15,23,33);
        ...
        //for(MountainBike bike:bicycles)
